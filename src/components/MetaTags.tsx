...
const DEFAULT_DESCRIPTION = 'Get all livescore live. Track all live football scores, flashlivesoccer, futbol24 livescore, bbc football scores, and premier league results. 
    Complete football match live score.';
